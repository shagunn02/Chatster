    ...
    justify-center'>
      ...
      rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <button onClick={() => navigate('/')} type='submit' className='bg-gradient-to-r  from-purple-400
          to-violet-600 text-white p-2 rounded-full text-lg cursor-pointer'>Save
          </button>
        </form>
        <img className={`max-w-44 aspect-square rounded-full max-10 max-sm:mt:10 ${selectedImg &&
